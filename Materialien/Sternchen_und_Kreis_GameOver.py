...
class Sternchen():
    ...
    def gameover(self):
        ...
        message = self.feld.create_text(400 / 2, 400 / 3, font="cmr 60 bold", fill='red', text=text)
...
feld.pack()
start()
#startknopf = tk.Button(fenster, text='Spiel starten', bg='red', fg='orange', command=lambda: start())
#startknopf.pack()
fenster.mainloop()