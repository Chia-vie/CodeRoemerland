from colorutils import random_hex
import ctypes
...
size_of_board = screensize / 2
Reihen = screensize / 80
Reihen1 = screensize / 80
rows = int(Reihen)
cols = int(Reihen1)
DELAY = int(Reihen * 4)
...
symbol_thickness = 2
RED_COLOR = random_hex()
BLUE_COLOR = random_hex()
Green_color = random_hex()

BLUE_COLOR_LIGHT = random_hex()
RED_COLOR_LIGHT = random_hex()
class SnakeAndApple:
    # ------------------------------------------------------------------
